	...
	<table class="shop_table ui--box my_account_orders">
		...
		<thead>
			<tr class="ui--gradient ui--gradient-grey">
				<th class="order-number"><span class="nobr"><?php esc_attr_e( 'Order', 'woocommerce' ); ?></span></th>
				<th class="order-date"><span class="nobr"><?php esc_attr_e( 'Date', 'woocommerce' ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php esc_attr_e( 'Status', 'woocommerce' ); ?></span></th>
				<th class="order-total"><span class="nobr"><?php esc_attr_e( 'Total', 'woocommerce' ); ?></span></th>
