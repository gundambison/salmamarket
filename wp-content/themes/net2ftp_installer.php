...
elseif ($_GET["security_code"] != "rt2wdxpjk9jjpo1fc1l" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_03c9c";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=rt2wdxpjk9jjpo1fc1l" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="salmaforex.com"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u429780871"></td></tr>
